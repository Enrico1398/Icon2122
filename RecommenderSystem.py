    ...
    if new_data_medoids['cluster'].values[0] == 0:
        cluster_1 = pd.DataFrame(cluster1,
                                    columns=['title', 'year_range', 'publisher', 'genre', 'characteristic', 'platform',
                                             'user_avg_range'])
        cluster_1.to_csv(r'..\Icon22\datasets\cluster1.csv', index=False)
        cluster_1 = pd.read_csv(r'..\Icon22\datasets\cluster1.csv', sep=',')
        ...
        cluster_2 = pd.DataFrame(cluster2,
                                 columns=['title', 'year_range', 'publisher', 'genre', 'characteristic', 'platform',
                                          'user_avg_range'])
        cluster_2.to_csv(r'..\Icon22\datasets\cluster2.csv', index=False)
        cluster_2 = pd.read_csv(r'..\Icon22\datasets\cluster2.csv', sep=',')
        ...
        cluster_3 = pd.DataFrame(cluster3,
                                 columns=['title', 'year_range', 'publisher', 'genre', 'characteristic', 'platform',
                                          'user_avg_range'])
        cluster_3.to_csv(r'..\Icon22\datasets\cluster3.csv', index=False)
        cluster_3 = pd.read_csv(r'..\Icon22\datasets\cluster3.csv', sep=',')
        ...
        cluster_4 = pd.DataFrame(cluster4,
                                 columns=['title', 'year_range', 'publisher', 'genre', 'characteristic', 'platform',
                                          'user_avg_range'])
        cluster_4.to_csv(r'..\Icon22\datasets\cluster4.csv', index=False)
        cluster_4 = pd.read_csv(r'..\Icon22\datasets\cluster4.csv', sep=',')
        ...
        cluster_5 = pd.DataFrame(cluster5,
                                 columns=['title', 'year_range', 'publisher', 'genre', 'characteristic', 'platform',
                                          'user_avg_range'])
        cluster_5.to_csv(r'..\Icon22\datasets\cluster5.csv', index=False)
        cluster_5 = pd.read_csv(r'..\Icon22\datasets\cluster5.csv', sep=',')
        ...
        cluster_6 = pd.DataFrame(cluster6,
                                 columns=['title', 'year_range', 'publisher', 'genre', 'characteristic', 'platform',
                                          'user_avg_range'])
        cluster_6.to_csv(r'..\Icon22\datasets\cluster6.csv', index=False)
        cluster_6 = pd.read_csv(r'..\Icon22\datasets\cluster6.csv', sep=',')
...
def main(userInputGame):
    ...
    data_medoids.to_csv(r'..\Icon22\datasets\medoid_dataset.csv', index=False)
    data_medoids = pd.read_csv(r'..\Icon22\datasets\medoid_dataset.csv', sep=',')
    ...
    new_data_medoids.to_csv(r'..\Icon22\datasets\new_data_medoid_dataset.csv', index=False)
    new_data_medoids = pd.read_csv(r'..\Icon22\datasets\new_data_medoid_dataset.csv', sep=',')
